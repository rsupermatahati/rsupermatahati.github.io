...
<template>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 w-full md:w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div class="order-2 md:order-1 w-full flex justify-center md:justify-start items-center">
        <div class="text-center md:text-start mt-8 md:mt-0">
          <h3 class="text-2xl md:text-3xl lg:text-4xl font-medium text-green-700">RSU Permata Hati</h3>
          <h1 class="text-4xl lg:text-5xl xl:text-6xl font-bold italic text-emerald-800 mt-3">CARE WITH LOVE</h1>
          <p class="text-gray-700 text-justify md:pe-4 lg:pe-12 mt-3">
          ...
          <button
            class="bg-emerald-700 hover:bg-emerald-600 text-white font-bold leading-8 px-6 md:px-8 py-1 rounded mt-4">Button CTA
          </button>
        </div>
      </div>
    </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="w-full">
          <div class="aspect-[4/3]">
            <img :src="ambulance" alt="RSU Permata Hati"
        ...
        <div class="w-full">
          ...
          <p class="text-gray-700 dark:text-gray-300 mb-8 text-justify">
            ...
            <div class="flex items-start space-x-3">
              ...
              <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">
                  Kami mencatat identitas pasien, hasil pemeriksaan, pengobatan, tindakan, dan pelayanan secara
                  elektronik, sehingga lebih aman, cepat, dan mudah diakses.
                </p>
              </div>
            </div>
            <div class="flex items-start space-x-3">
              ...
              <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">
                  RSU Permata Hati melayani asuransi kesehatan dengan sistem reimbursement maupun melalui BPJS
                  Kesehatan, demi memudahkan pasien dalam mendapatkan layanan.
                </p>
              </div>
            </div>
            <div class="flex items-start space-x-3">
              ...
              <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">
                  Kami berkomitmen memberikan pelayanan terbaik dengan harga yang terjangkau, tanpa mengurangi kualitas
                  perawatan dan kenyamanan pasien.
                </p>
              </div>
            </div>
            <div class="flex items-start space-x-3">
              ...
              <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">
                  Pasien dapat melakukan konsultasi kesehatan dengan dokter spesialis sesuai kebutuhan, untuk
                  mendapatkan diagnosa dan solusi medis yang tepat.
                </p>
              </div>
            </div>
          </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-20">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="order-1 xl:order-2 w-full">
          <div class="aspect-[4/3]">
            <img :src="ambulance01" alt="Ambulance RSU Permata Hati"
              class="w-full h-full object-cover object-center rounded-lg shadow-lg" />
          </div>
        </div>
  ...
  <section>
    <div class="w-full bg-top bg-cover h-[20rem] lg:h-[24rem]"
      ...
      <div class="flex items-center justify-center w-full h-full bg-gradient-to-r from-emerald-800/95 to-green-600/95">
  ...
  <section class="py-4 mt-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="flex flex-col items-center">
        <h2 class="text-xl sm:text-2xl md:text-3xl font-bold text-center text-emerald-700 mb-4">
          Dokter Spesialis RSU Permata Hati
        </h2>
        <div class="w-24 border border-t-4 border-emerald-700"></div>
      </div>
      <!-- Scrollable Container -->
      <div class="mt-8 overflow-x-auto rounded-lg px-1 pb-4 hide-scrollbar">
        <div class="flex flex-row justify-between items-center gap-4">
          <!-- Card 1 -->
          <div class="bg-white rounded-lg shadow overflow-hidden flex-shrink-0 w-72">
            <div class="aspect-square">
              <img :src="avatar" alt="Rekam Medis Elektronik" class="w-full h-full object-cover" />
            </div>
            <div class="p-6">
              <h3 class="text-lg font-semibold text-emerald-700">dr. Nama Dokter Spesialis, Sp.???</h3>
              <p class="mt-2 text-gray-600 text-sm">Dokter Spesialis</p>
            </div>
          </div>
          <!-- Card 2 -->
          <div class="bg-white rounded-lg shadow overflow-hidden flex-shrink-0 w-72">
  ...
  <section class="py-4 mt-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-8 overflow-x-auto rounded-lg px-1 pb-4 hide-scrollbar">
        <div class="flex flex-row justify-between items-center gap-4">
          <!-- Card 1 -->
          <div class="bg-white rounded-lg shadow overflow-hidden flex-shrink-0 w-96">
            <div class="aspect-[4/3]">
              <img :src="ambulance01" alt="Rekam Medis Elektronik" class="w-full h-full object-cover" />
            </div>
            <div class="p-6">
              <h3 class="text-lg font-semibold text-emerald-700">President Suite</h3>
              <p class="mt-2 text-gray-600 text-sm">VVIP</p>
            </div>
          </div>
          <!-- Card 2 -->
          <div class="bg-white rounded-lg shadow overflow-hidden flex-shrink-0 w-96">
            ...
            <div class="p-6">
              <h3 class="text-lg font-semibold text-emerald-700">Suite</h3>
              <p class="mt-2 text-gray-600 text-sm">VIP</p>
            </div>
          </div>
          <!-- Card 3 -->
          <div class="bg-white rounded-lg shadow overflow-hidden flex-shrink-0 w-96">
            ...
            <div class="p-6">
              <h3 class="text-lg font-semibold text-emerald-700">Emerald</h3>
              <p class="mt-2 text-gray-600 text-sm">Kelas 1</p>
            </div>
          </div>
